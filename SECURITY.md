...
step. Confidence floors (`min-confidence`, default `0.7`) ignore replies that
do not clear the bar. Category `fail-on-*` bars default to `0.8`. The 0.70
follow-up threshold is not a CI fail bar.
